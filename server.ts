...
async function startServer() {
  ...
  app.get("/api/auth/github/url", (req, res) => {
    let redirectUri;
    // Prioritize APP_URL environment variable for reliability
    if (process.env.APP_URL) {
      ...
      redirectUri = `${protocol}://${host}/auth/github/callback`;
    }
    
    console.log(`[GitHub Auth] Generating URL with redirectUri: ${redirectUri}`);
