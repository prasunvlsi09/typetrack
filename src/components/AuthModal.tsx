    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className={`${mode === 'devlog' || mode === 'devsignup' || mode === 'dev_select' ? 'bg-white text-black' : 'bg-[#111] text-white'} border border-white/10 rounded-3xl shadow-2xl overflow-y-auto max-h-[85vh] relative`}>
              {/* Close Button */}
              <button
                onClick={onClose}
