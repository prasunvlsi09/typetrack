    ...
    <AnimatePresence>
      {isTopeSidebarOpen && (
        <motion.div
          ...
          className={`fixed bottom-24 right-6 w-96 max-h-[85vh] z-50 flex flex-col shadow-2xl rounded-3xl border backdrop-blur-3xl backdrop-saturate-200 overflow-hidden ${isLight ? 'bg-white/60 border-white/50' : 'bg-black/60 border-white/10'}`}
        >
          {/* Header */}
