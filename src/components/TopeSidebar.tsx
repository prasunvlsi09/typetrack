    ...
    <AnimatePresence>
      {isTopeSidebarOpen && (
        <motion.div
          ...
          className={`fixed bottom-24 right-6 w-96 max-h-[85vh] z-50 flex flex-col shadow-2xl rounded-3xl border backdrop-blur-md overflow-hidden ${isLight ? 'bg-white/90 border-black/10' : 'bg-black/90 border-white/10'}`}
        >
          {/* Header */}
