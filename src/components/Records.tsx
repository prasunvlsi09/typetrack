      ...
      <div className="flex items-center justify-between mb-12">
        ...
        <MagneticEffect>
          <button
            ...
            className={`flex items-center space-x-2 px-6 py-3 rounded-full transition-all duration-300 font-semibold ${isLight ? 'apple-glass-light text-black hover:bg-white/60' : 'apple-glass-dark text-white hover:bg-white/10'}`}
          >
