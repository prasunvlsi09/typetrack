    ...
    >
      <div className="flex items-center justify-between mb-12">
        ...
        <button
          ...
          className={`flex items-center space-x-2 px-6 py-3 border rounded-full backdrop-blur-md transition-all duration-300 font-semibold ${isLight ? 'bg-black/5 hover:bg-black/10 border-black/10 text-black' : 'bg-white/10 hover:bg-white/20 border-white/30 text-white'}`}
        >
