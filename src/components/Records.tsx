      ...
      <div className="flex items-center justify-between mb-12">
        ...
        <MagneticEffect>
          <button
            ...
            className={`flex items-center space-x-2 px-6 py-3 border rounded-full backdrop-blur-2xl backdrop-saturate-200 shadow-lg transition-all duration-300 font-semibold ${isLight ? 'bg-white/40 hover:bg-white/60 border-white/50 text-black' : 'bg-black/40 hover:bg-black/60 border-white/10 text-white'}`}
          >
