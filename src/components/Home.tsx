      ...
      <div className="flex justify-center pt-8">
        <MagneticEffect>
          <button
            ...
            className={`group relative px-8 py-4 border rounded-full backdrop-blur-2xl backdrop-saturate-200 transition-all duration-300 flex items-center space-x-3 ${isLight ? 'bg-white/40 hover:bg-white/60 border-white/50 shadow-[0_0_40px_rgba(0,0,0,0.05)] hover:shadow-[0_0_60px_rgba(0,0,0,0.1)]' : 'bg-black/40 hover:bg-black/60 border-white/10 shadow-[0_0_40px_rgba(255,255,255,0.1)] hover:shadow-[0_0_60px_rgba(255,255,255,0.2)]'}`}
          >
