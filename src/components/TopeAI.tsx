...
export function TopeAI() {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -20 }}
      className={`max-w-6xl mx-auto h-[calc(100vh-12rem)] flex border rounded-3xl overflow-hidden backdrop-blur-sm shadow-2xl relative ${isLight ? 'bg-black/5 border-black/10' : 'bg-white/5 border-white/10'}`}
    >
      {/* Sidebar */}
