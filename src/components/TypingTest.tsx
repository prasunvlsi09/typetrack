      ...
      >
        ...
        <div className="flex justify-center space-x-4">
          <button
            ...
            className={`px-8 py-4 border rounded-full backdrop-blur-md transition-all duration-300 font-semibold flex items-center space-x-2 ${isLight ? 'bg-black/5 hover:bg-black/10 border-black/20 text-black' : 'bg-white/10 hover:bg-white/20 border-white/30 text-white'}`}
          >
          ...
          {!sessionSaved && (
            <button
              ...
              className="px-8 py-4 bg-emerald-500/20 hover:bg-emerald-500/30 border border-emerald-500/50 rounded-full backdrop-blur-md transition-all duration-300 text-emerald-500 font-semibold flex items-center space-x-2"
            >
