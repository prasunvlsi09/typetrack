...
export function Dashboard() {
  const { sessions, addSession, clearSessions, settings, user, userRole } = useAppContext();
        ...
        <div className="flex items-center space-x-4">
          {isDev && (
            <MagneticEffect>
              <button
                ...
                className={`flex items-center justify-center space-x-2 px-6 py-3 border rounded-full backdrop-blur-3xl backdrop-saturate-200 shadow-lg transition-all duration-300 font-semibold ${isLight ? 'bg-red-500/20 hover:bg-red-500/30 border-red-500/30 text-red-600' : 'bg-red-500/20 hover:bg-red-500/30 border-red-500/30 text-red-400'}`}
          ...
          <MagneticEffect>
            <button
              ...
              className={`flex items-center justify-center space-x-2 px-6 py-3 border rounded-full backdrop-blur-3xl backdrop-saturate-200 shadow-lg transition-all duration-300 font-semibold ${isLight ? 'bg-white/60 hover:bg-white/80 border-white/50 text-black' : 'bg-white/5 hover:bg-white/10 border-white/10 text-white'}`}
            >
