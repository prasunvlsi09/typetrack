        ...
        <div className="flex items-center space-x-4">
          {isDev && (
            <button
              ...
              className={`flex items-center justify-center space-x-2 px-6 py-3 border rounded-full backdrop-blur-md transition-all duration-300 font-semibold ${isLight ? 'bg-red-500/10 hover:bg-red-500/20 border-red-500/20 text-red-600' : 'bg-red-500/20 hover:bg-red-500/30 border-red-500/30 text-red-400'}`}
          ...
          <button
            ...
            className={`flex items-center justify-center space-x-2 px-6 py-3 border rounded-full backdrop-blur-md transition-all duration-300 font-semibold ${isLight ? 'bg-black/5 hover:bg-black/10 border-black/10 text-black' : 'bg-white/10 hover:bg-white/20 border-white/30 text-white'}`}
          >
