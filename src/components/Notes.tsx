...
export function Notes() {
  ...
  return (
    ...
    >
      {/* Sidebar */}
      <div className={`w-80 flex flex-col rounded-3xl border backdrop-blur-3xl backdrop-saturate-200 shadow-xl overflow-hidden ${isLight ? 'bg-white/60 border-white/50' : 'bg-white/5 border-white/10'}`}>
      ...
      {/* Editor */}
      <div className={`flex-1 rounded-3xl border backdrop-blur-3xl backdrop-saturate-200 shadow-xl overflow-hidden flex flex-col ${isLight ? 'bg-white/60 border-white/50' : 'bg-white/5 border-white/10'}`}>
        {selectedNote ? (
          <>
