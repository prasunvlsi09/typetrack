...
export function Notes() {
  ...
  return (
    ...
    >
      {/* Sidebar */}
      <div className={`w-80 flex flex-col rounded-3xl border backdrop-blur-md overflow-hidden ${isLight ? 'bg-white/50 border-black/10' : 'bg-black/20 border-white/10'}`}>
      ...
      {/* Editor */}
      <div className={`flex-1 rounded-3xl border backdrop-blur-md overflow-hidden flex flex-col ${isLight ? 'bg-white/50 border-black/10' : 'bg-black/20 border-white/10'}`}>
        {selectedNote ? (
          <>
