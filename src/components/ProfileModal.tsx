      ...
      {isOpen && user && (
        ...
        >
          <motion.div
            ...
            className={`relative w-full max-w-md overflow-hidden rounded-3xl shadow-2xl flex flex-col backdrop-blur-3xl backdrop-saturate-200 border ${
          ...
          <div className="p-6">
            <div className="flex items-center space-x-4 mb-8">
              ...
              >
                {user.photoURL ? (
                  <img src={user.photoURL} alt="Profile" className="w-16 h-16 rounded-full object-cover" referrerPolicy="no-referrer" />
                ) : (
                  ...
                  {PREMADE_AVATARS.map((url, i) => (
                    <button
                      ...
                      className={`relative aspect-square rounded-xl overflow-hidden border-2 transition-all hover:scale-105 ${
                        user.photoURL === url ? 'border-emerald-500' : 'border-transparent hover:border-emerald-500/50'
                      }`}
                    >
