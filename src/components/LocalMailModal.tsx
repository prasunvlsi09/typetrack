  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className={`relative w-full max-w-2xl overflow-hidden rounded-2xl shadow-2xl flex flex-col max-h-[80vh] ${
          isLight ? 'bg-white/90 text-black' : 'bg-gray-900/90 text-white'
        } backdrop-blur-xl border ${isLight ? 'border-black/10' : 'border-white/10'}`}
      >
